...
public class Robot extends TimedRobot implements RobotProperties {
  ...
  private volatile boolean driveFlipEdgeTrigger, quickTurnEdgeTrigger;
  ...
  public void autonomousPeriodic() {
    ...
    switch (selectedAutonMode) {
      ...
      case kPlaybackAutonThree:
        ...
        break;
      case kHardcodedAuton:
        HardcodedAutons.Auton_Center(driveController, gyro, gyroPIDController, shooterController);
        break;
  ...
  public void teleopPeriodic() {
    ...
    final boolean button_FlipDriveDirection = leftStick.getRawButton(2);
    ...
    if (button_FlipDriveDirection && !driveFlipEdgeTrigger) {
      driveController.toggleDriveDirectionFlipped();
    }
    driveFlipEdgeTrigger = button_FlipDriveDirection;
